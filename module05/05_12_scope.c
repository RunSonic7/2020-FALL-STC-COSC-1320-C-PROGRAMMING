/* Filename: 05_12_scope.c
   Title:  A Scoping Example
...
/* function main begina program execution */
int main(void)
{
...
void useLocal(void)
{
    int x = 25; /* initalized each time useLocal is called */
