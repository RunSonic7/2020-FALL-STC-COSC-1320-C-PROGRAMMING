/* Filename: 06_16_arraySurveyAnalysis.c
   Title:  Survey Analysis - Mean, Median, Mode
   ...
   Notes: This program introduces the topic of survey data analysis.
...
void mean(const int answer[])
{
    ...
    int total = 0; /* variables to hold sum of array elements */
...
void median(int answer[])
{
    ...
    bubbleSort(answer); /* output sorted array */
...
void mode(int freq[], const int answer[])
{
    ...
    int j; /* counter for summarizing elemnts 0-98 of array answer */
